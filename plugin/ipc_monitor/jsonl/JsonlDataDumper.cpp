...
namespace
{
inline std::string GetRotateLogEnvValue(const char *envName, const std::string &paramName)
{
...
inline std::string ResolveRotateLogValue(const std::string &paramValue, const char *envName,
